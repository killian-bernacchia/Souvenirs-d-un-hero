...
void drawDialogueGuardien(){    
    ...
    DrawText(guardien[indexGuardien], 25, 660, 25, BLACK);

    // DrawTextEx(font, guardien[indexGuardien], (Vector2){ 25.0f, 660.0f }, (float)25, 2, MAROON);
    }
...
void drawDialogueFeuFollet(){
    ...
    DrawText(feuxfollet[indexfeuxfollet], 25, 660, 25, BLACK);
}